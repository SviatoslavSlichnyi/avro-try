...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7101451117678340658L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroHttpRequest\",\"namespace\":\"study.baeldung.avroex.entity\",\"fields\":[{\"name\":\"requestTime\",\"type\":\"long\"},{\"name\":\"clientIdentifier\",\"type\":{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}},{\"name\":\"employeeNames\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"active\",\"type\":{\"type\":\"enum\",\"name\":\"Active\",\"symbols\":[\"YES\",\"NO\"]}}]}");
  ...
  @Deprecated public study.baeldung.avroex.entity.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<java.lang.CharSequence> employeeNames;
  @Deprecated public study.baeldung.avroex.entity.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, study.baeldung.avroex.entity.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, study.baeldung.avroex.entity.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (study.baeldung.avroex.entity.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (study.baeldung.avroex.entity.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public study.baeldung.avroex.entity.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(study.baeldung.avroex.entity.ClientIdentifier value) {
   ...
   */
  public study.baeldung.avroex.entity.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(study.baeldung.avroex.entity.Active value) {
    this.active = value;
  }
   ...
   */
  public static study.baeldung.avroex.entity.AvroHttpRequest.Builder newBuilder() {
    return new study.baeldung.avroex.entity.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static study.baeldung.avroex.entity.AvroHttpRequest.Builder newBuilder(study.baeldung.avroex.entity.AvroHttpRequest.Builder other) {
    return new study.baeldung.avroex.entity.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static study.baeldung.avroex.entity.AvroHttpRequest.Builder newBuilder(study.baeldung.avroex.entity.AvroHttpRequest other) {
    return new study.baeldung.avroex.entity.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private study.baeldung.avroex.entity.ClientIdentifier clientIdentifier;
    private study.baeldung.avroex.entity.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private study.baeldung.avroex.entity.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(study.baeldung.avroex.entity.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = study.baeldung.avroex.entity.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(study.baeldung.avroex.entity.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder setClientIdentifier(study.baeldung.avroex.entity.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public study.baeldung.avroex.entity.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(study.baeldung.avroex.entity.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(study.baeldung.avroex.entity.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder setClientIdentifierBuilder(study.baeldung.avroex.entity.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder setActive(study.baeldung.avroex.entity.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public study.baeldung.avroex.entity.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (study.baeldung.avroex.entity.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (study.baeldung.avroex.entity.Active) defaultValue(fields()[3]);
        return record;
